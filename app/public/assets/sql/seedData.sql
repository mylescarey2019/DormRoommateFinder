...
--  WHERE student_id = 12;
   ...
   SET photo = "https://loremflickr.com/320/240/student?random=1"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 1;

UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=5"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 2;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=10"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 3;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=3"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 4;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=7"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 5;

UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=4"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 6;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=13"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 7;
 
UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=11"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 8;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=15"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 9;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=12"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 10;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=14"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 11;
 
 UPDATE student
   SET photo = "https://loremflickr.com/320/240/student?random=6"
   -- SET photo = 'http://lorempixel.com/320/240/people/'
 WHERE student_id = 12;